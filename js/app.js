...
function GameBoard(rows, cols, elementId) {
    ...
    this.play = function (x, y) {
        ...
        if(cell.value === VALUE_EMPTY){
            ...
            alert("Phải đánh vào ô còn trống");
        }
    };
...
function start() {
    let gameBoardRow = prompt("Nhập vào số dòng của bàn cờ");
    let gameBoardCol = prompt("Nhập vào số cột của bàn cờ");
    gameBoard = new GameBoard(gameBoardRow, gameBoardCol, "game-board");
    gameBoard.draw();
}
var gameBoard;
